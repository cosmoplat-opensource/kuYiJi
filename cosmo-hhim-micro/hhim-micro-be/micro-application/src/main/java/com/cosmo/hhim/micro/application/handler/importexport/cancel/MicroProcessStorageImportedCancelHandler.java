...
@HandlerType(type = HandlerTypeEnum.IMPORT_TASK_PROCESS_STORAGE_CANCEL)
public class MicroProcessStorageImportedCancelHandler implements MicroImportedHandler {
    ...
    public boolean doHandler(Object o) {
        microProcessStorageImportedTempService.importCancel();
        return true;
    }
}
