...
@HandlerType(type = HandlerTypeEnum.IMPORT_TASK_TECHNOLOGY_CANCEL)
public class MicroTechnologyImportedCancelHandler implements MicroImportedHandler {

    private final IMicroTechImportedFacadeService microTechImportedFacadeService;

    @Override
    public boolean doHandler(Object o) {
        microTechImportedFacadeService.importCancel();
        return true;
    }
}
