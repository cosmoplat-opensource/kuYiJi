 ...
 * @date 2023-06-01
 */
public interface MicroUserIndividuationConfigMapper {
    /**
     * 查询用户个性化配置
     *
     * @param id 用户个性化配置ID
    ...
    public MicroUserIndividuationConfig selectOneByUserId(Long userId); 
    ...
    public int updateMicroUserIndividuationConfigByUser(MicroUserIndividuationConfig microUserIndividuationConfig); 
