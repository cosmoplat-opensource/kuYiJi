<template>
  <scroll-view
    scroll-y
    class="m-h-500 w-100 box bg-fff overflow-auto absolute product-item-wrapper"
    style="z-index: 99"
  >
    ...
    <template v-else>
      <view class="product-item flex align-center">
        <image src="/static/images/icon_s_b8.svg" class="icon-24" />
        <text class="font-28 color-b8b8b8 ml-16 flex-1">未查到相关工序，请重新输入</text>
