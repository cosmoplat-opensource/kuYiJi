 ...
 */
package com.cosmo.hhim.easypoi;
...
public class ExcelBatchExportService extends ExcelExportService {
    ...
    public void init(ExportParams entity, Class<?> pojoClass,Map<String, String> custom) {
        List<ExcelExportEntity> excelParams = createExcelExportEntityList(entity, pojoClass,custom);
        init(entity, excelParams,custom);
    }

    public void init(ExportParams entity, List<ExcelExportEntity> excelParams,Map<String, String> custom) {
        ...
        insertDataToSheet(workbook, entity, excelParams, null, sheet,custom);
    }

    public List<ExcelExportEntity> createExcelExportEntityList(ExportParams entity, Class<?> pojoClass,Map<String, String> custom) {
        try {
            ...
            getAllExcelField(entity.getExclusions(), targetId, fileds, excelParams, pojoClass,
                    null, null);
            //todo
            getAllExcelFieldCustom(entity.getExclusions(), targetId, fileds, excelParams, pojoClass,
                    null, null,custom);
    ...
    protected void insertDataToSheet(Workbook workbook, ExportParams entity,
                                     ...
                                     Sheet sheet,Map<String, String> custom) {
        try {
    ...
    public Workbook exportBigExcel(IExcelExportServer server, Object queryParams,Map<String, String> custom) {
        int page = 1;
