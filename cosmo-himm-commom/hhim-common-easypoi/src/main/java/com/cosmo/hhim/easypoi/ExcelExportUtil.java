...
public final class ExcelExportUtil {
    ...
    public static Workbook exportBigExcel(ExportParams entity, Class<?> pojoClass,
                                          IExcelExportServer server, Object queryParams, Map<String, String> custom) {
        ExcelBatchExportService batchServer = new ExcelBatchExportService();
        batchServer.init(entity, pojoClass,custom);
        return batchServer.exportBigExcel(server, queryParams,custom);
    }
    ...
    public static Workbook exportBigExcel(ExportParams entity, List<ExcelExportEntity> excelParams,
                                          IExcelExportServer server, Object queryParams,Map<String, String> custom) {
        ExcelBatchExportService batchServer = new ExcelBatchExportService();
        batchServer.init(entity, excelParams,custom);
        return batchServer.exportBigExcel(server, queryParams,custom);
    }
