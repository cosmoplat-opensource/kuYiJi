...
import com.cosmo.hhim.common.log.enums.BusinessStatus;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.cosmo.hhim.common.log.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            ...
            String username = ServletUtils.getHeader(CacheConstants.DETAILS_USER_ID);
            ...
            // 设置所属系统
            operLog.setBelongSys(applicationName);
            // 设置操作来源平台
            operLog.setOperPlatformSource(ServletUtils.getHeader(CacheConstants.TYPE));
            // 处理设置注解上的参数
            ...
            for (int i = 0; i < paramsArray.length; i++) {
                if (!isFilterObject(paramsArray[i])) {
                    try {
                        ...
                        log.warn("serialize log param failed: {}", e.getMessage(), e);
                    }
                }
            }
        }
