 ...
 */
@Slf4j
public class GainWebTokenInterceptor implements Interceptor<WebAccessTokenInfo> {
    ...
    public boolean beforeExecute(ForestRequest request) {
        log.info("http请求前置拦截器--->web access token的请求参数赋值");
        ...
        request.addQuery(APP_ID, wechatConfig.getAppId()).addQuery(APP_SECRET, wechatConfig.getAppSecret()).addQuery(GRANT_TYPE, "authorization_code");
